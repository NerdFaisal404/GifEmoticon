...
JNIEXPORT jlong JNICALL Java_com_hoanganhtuan95ptit_emoticon_utils_EmoticonDecoder_nativeInit
  (JNIEnv *env, jobject)
{
    return (jlong)new GifDecoder();
}

JNIEXPORT void JNICALL Java_com_hoanganhtuan95ptit_emoticon_utils_EmoticonDecoder_nativeClose
  (JNIEnv *, jobject, jlong handle)
{
    delete (GifDecoder*)handle;
}

JNIEXPORT jboolean JNICALL Java_com_hoanganhtuan95ptit_emoticon_utils_EmoticonDecoder_nativeLoad
...
JNIEXPORT jlong JNICALL Java_com_hoanganhtuan95ptit_emoticon_utils_EmoticonDecoder_nativeLoadUsingIterator
  (JNIEnv * env, jobject, jlong handle, jstring fileName)
{
    const char* fileNameChars = env->GetStringUTFChars(fileName, 0);
...
JNIEXPORT jint JNICALL Java_com_hoanganhtuan95ptit_emoticon_utils_EmoticonDecoder_nativeGetFrameCount
  (JNIEnv *, jobject, jlong handle)
{
    return ((GifDecoder*)handle)->getFrameCount();
}

JNIEXPORT jobject JNICALL Java_com_hoanganhtuan95ptit_emoticon_utils_EmoticonDecoder_nativeGetFrame
...
JNIEXPORT jint JNICALL Java_com_hoanganhtuan95ptit_emoticon_utils_EmoticonDecoder_nativeGetDelay
        (JNIEnv *, jobject, jlong handle, jint idx)
{
    return ((GifDecoder*)handle)->getDelay(idx);
}

JNIEXPORT jint JNICALL Java_com_hoanganhtuan95ptit_emoticon_utils_EmoticonDecoder_nativeGetWidth
  (JNIEnv *, jobject, jlong handle)
{
    return ((GifDecoder*)handle)->getWidth();
}

JNIEXPORT jint JNICALL Java_com_hoanganhtuan95ptit_emoticon_utils_EmoticonDecoder_nativeGetHeight
  (JNIEnv *, jobject, jlong handle)
{
    return ((GifDecoder*)handle)->getHeight();
}

JNIEXPORT jboolean JNICALL Java_com_hoanganhtuan95ptit_emoticon_utils_EmoticonDecoder_nativeBitmapIteratorHasNext
  (JNIEnv *, jobject, jlong handle)
{
    return ((BitmapIterator*)handle)->hasNext();
}

JNIEXPORT jobject JNICALL Java_com_hoanganhtuan95ptit_emoticon_utils_EmoticonDecoder_nativeBitmapIteratornext
